...
namespace GP.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TrainTypeCoachConfigs",
                columns: table => new
                {
                    TrainTypeCoachConfigId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrainTypeId = table.Column<int>(type: "int", nullable: false),
                    CoachClassId = table.Column<int>(type: "int", nullable: false),
                    NumberOfCoaches = table.Column<int>(type: "int", nullable: false),
                    SeatsPerCoach = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainTypeCoachConfigs", x => x.TrainTypeCoachConfigId);
                    table.ForeignKey(
                        name: "FK_TrainTypeCoachConfigs_CoachClasses_CoachClassId",
                        column: x => x.CoachClassId,
                        principalTable: "CoachClasses",
                        principalColumn: "CoachClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainTypeCoachConfigs_TrainTypes_TrainTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TripId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AgencyId = table.Column<int>(type: "int", nullable: false),
                    TrainTypeId = table.Column<int>(type: "int", nullable: true),
                    ...
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    ServiceClass = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_TrainTypes_TrainTypeId",
                        column: x => x.TrainTypeId,
                        principalTable: "TrainTypes",
                        principalColumn: "TrainTypeId",
            ...
            migrationBuilder.CreateTable(
                name: "TripClassPricings",
                columns: table => new
                {
                    TripClassPricingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TripId = table.Column<int>(type: "int", nullable: false),
                    CoachClassId = table.Column<int>(type: "int", nullable: false),
                    ...
                    FullDistanceKm = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    MinimumPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    RoundingStep = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripClassPricings", x => x.TripClassPricingId);
                    table.ForeignKey(
                        name: "FK_TripClassPricings_CoachClasses_CoachClassId",
                        column: x => x.CoachClassId,
                        principalTable: "CoachClasses",
                        principalColumn: "CoachClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripClassPricings_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartureOffsetMinutes = table.Column<int>(type: "int", nullable: false),
                    DistanceFromOriginKm = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TripId_OccurrenceId_CoachClassId",
                table: "Bookings",
                columns: new[] { "TripId", "OccurrenceId", "CoachClassId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stops_StopName_City",
                table: "Stops",
                columns: new[] { "StopName", "City" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainTypeCoachConfigs_CoachClassId",
                table: "TrainTypeCoachConfigs",
                column: "CoachClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainTypeCoachConfigs_TrainTypeId_CoachClassId",
                table: "TrainTypeCoachConfigs",
                columns: new[] { "TrainTypeId", "CoachClassId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainTypes_Name",
                table: "TrainTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TripClassPricings_CoachClassId",
                table: "TripClassPricings",
                column: "CoachClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TripClassPricings_TripId",
                table: "TripClassPricings",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TripClassPricings_TripId_CoachClassId",
                table: "TripClassPricings",
                columns: new[] { "TripId", "CoachClassId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripStopTimes_TripId_StationId",
                table: "TripStopTimes",
