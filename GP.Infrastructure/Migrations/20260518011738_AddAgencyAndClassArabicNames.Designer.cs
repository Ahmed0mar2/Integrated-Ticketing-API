...
namespace GP.Infrastructure.Migrations
{
    ...
    [Migration("20260518011738_AddAgencyAndClassArabicNames")]
    partial class AddAgencyAndClassArabicNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GP.Domain.Entities.Agency", b =>
                {
                    ...
                    b.Property<string>("AgencyNameAr")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("GP.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<bool>("IsBoardingAlertSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GP.Domain.Entities.BookingPassenger", b =>
                {
                    ...
                    b.Property<bool>("IsOfferedForResale")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("GP.Domain.Entities.Challenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.DiscountRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.PointTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsExpired", "ExpiresAt");

                    b.ToTable("PointTransactions", (string)null);
                });

            modelBuilder.Entity("GP.Domain.Entities.RouteSearchLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DestinationGov")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OriginGov")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GP.Domain.Entities.TripOccurrence", b =>
                {
                    ...
                    b.HasIndex("IsActive", "OccurrenceDate", "TripId");
            ...
            modelBuilder.Entity("GP.Domain.Entities.TripOccurrenceClassInventory", b =>
                {
                    ...
                    b.HasIndex("TripOccurrenceId", "CoachClassId", "RemainingSeats");
            ...
            modelBuilder.Entity("GP.Domain.Entities.UserChallenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GP.Domain.Entities.UserChallenge", b =>
                {
                    b.HasOne("GP.Domain.Entities.Challenge", "Challenge")
